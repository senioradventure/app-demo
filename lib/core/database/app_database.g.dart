...
abstract class _$FriendDatabase extends GeneratedDatabase {
  _$FriendDatabase(QueryExecutor e) : super(e);
  $FriendDatabaseManager get managers => $FriendDatabaseManager(this);
...
class $$FriendsTableTableFilterComposer
    extends Composer<_$FriendDatabase, $FriendsTableTable> {
...
class $$FriendsTableTableTableManager
    extends
        ...
        > {
  $$FriendsTableTableTableManager(_$FriendDatabase db, $FriendsTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$FriendsTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        FriendsTableData,
        BaseReferences<_$FriendDatabase, $FriendsTableTable, FriendsTableData>,
      ),
      FriendsTableData,
      PrefetchHooks Function()
    >;
...
class $FriendDatabaseManager {
  final _$FriendDatabase _db;
  $FriendDatabaseManager(this._db);
