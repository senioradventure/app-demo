...
final List<Message> message = [
  ...
  Message(id: '3', sender: 'You', text: 'Have a great day!', time: '10:05 AM'),
];

class MyCircleIndividualMessageCard extends StatelessWidget {
  const MyCircleIndividualMessageCard({super.key,});
