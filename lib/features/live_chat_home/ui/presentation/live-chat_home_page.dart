  ...
  builder: (ctx) {
    return OutlinedButton(
      ...
      child: Row(
        ...
        children: const [
          Icon(Icons.location_pin, size: 18, color: Colors.blueAccent),
          SizedBox(width: 6),
          Text(
            "by location",
            style: TextStyle(
  ...
  builder: (ctx) {
    return OutlinedButton(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: const [
          Icon(Icons.filter_alt, size: 18, color: Colors.blueAccent),
          SizedBox(width: 6),
          Text(
            "by interest",
            style: TextStyle(
    ...
    child: ValueListenableBuilder<List<Contact>>(
      ...
      builder: (context, list, _) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {if (index == list.length) {
if (index == list.length) {
      return Container(
        ...
        child: Center(
          child: Row( mainAxisSize: MainAxisSize.min,children:[SizedBox(height: 200),
Center(
  child: Text(
...
SizedBox(height: 200)],
  ...
  child: Padding(
    ...
    child: Row(
      ...
      children: [
        CircleAvatar(
          backgroundImage: const AssetImage('assets/image/Frame_24.png'),
          radius: 30, 
        ),
